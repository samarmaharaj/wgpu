...
if __name__ == "__main__":
    print("Setting up the benchmark...")
    # 1. Instantiate the benchmark class
    bench = BenchVecValSum() 
    
    # 2. Run its setup method to generate the fake data
    bench.setup()
    
    # 3. Run the actual math function 50 times to create a massive CPU load
    print("Running heavy math...")
    for _ in range(50):
        bench.time_vec_val_vect()
